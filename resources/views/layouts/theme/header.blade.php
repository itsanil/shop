            ...
            <div class="dropdown-menu menu-drop-user">
                ...
                <div class="profileset">
                    ...
                    <div class="profilesets">
                        ...
                        <h5>{{Auth::user()->getRoleNames()[0]}}</h5>
                    </div>
                </div>
                <hr class="m-0">
                @if(Auth::user()->hasRole('Shop'))
                <a class="dropdown-item" href="{{route('profile')}}"> <i class="me-2" data-feather="user"></i> My Profile</a>
                <a class="dropdown-item" href="{{ route('setting') }}"><i class="me-2" data-feather="settings"></i>Settings</a>
                <hr class="m-0">
                @endif
                <a class="dropdown-item logout pb-0" 
                    ...
                    <img src="https://dreamspos.dreamguystech.com/html/template/assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
                </div>
